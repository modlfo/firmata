...
(* OASIS_START *)
(* DO NOT EDIT (digest: 445199780729ab8e0c97b4fbadeae547) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/modlfo/firmata";
          synopsis = "Library to control Firmata boards like Arduino.";
          description =
            Some
              [
                 OASISText.Para
                   "Allows to control boards supporting the Firmata protocol (firmata.org) like Arduino boards."
              ];
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["firmata_stubs.c"; "serial.c"; "serial.h"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "firmata"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "SimpleExample.ml"});
               Executable
                 ({
                     cs_name = "NonBlockingExample";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "NonBlockingExample.ml"
                   });
               Doc
                 ({
                     cs_name = "firmata_api";
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for firmata";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\128\163\191\149$;\189S\2403\250R\202\133\247\240";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
